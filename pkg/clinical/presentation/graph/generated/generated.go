...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		PatchComposition             func(childComplexity int, id string, input dto.PatchCompositionInput) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.patchComposition":
		if e.complexity.Mutation.PatchComposition == nil {
			break
		}

		args, err := ec.field_Mutation_patchComposition_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.PatchComposition(childComplexity, args["id"].(string), args["input"].(dto.PatchCompositionInput)), true
...
extend type Mutation {
  ...
  patchComposition(id: String!, input: PatchCompositionInput!): Composition!
}
`, BuiltIn: false},
...
func (ec *executionContext) field_Mutation_patchComposition_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["id"]; ok {
...
func (ec *executionContext) _Mutation_patchComposition(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_patchComposition(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PatchComposition(rctx, fc.Args["id"].(string), fc.Args["input"].(dto.PatchCompositionInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_patchComposition(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_patchComposition_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputPatchCompositionInput(ctx context.Context, obj interface{}) (dto.PatchCompositionInput, error) {
	...
	fieldsInOrder := [...]string{"type", "status", "category", "encounterID", "note", "section"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSectionInput(ctx context.Context, obj interface{}) (dto.SectionInput, error) {
	...
	fieldsInOrder := [...]string{"title", "code", "author", "text", "section"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "patchComposition":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_patchComposition(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
