...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.patchHeight":
		...
		return e.complexity.Mutation.PatchHeight(childComplexity, args["id"].(string), args["value"].(string)), true
...
extend type Mutation {
  ...
  patchHeight(id: String!, value: String!): Observation!
}
`, BuiltIn: false},
...
func (ec *executionContext) _Mutation_patchHeight(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PatchHeight(rctx, fc.Args["id"].(string), fc.Args["value"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
