...
// RecordSpo2 is the resolver for the recordSpo2 field.
func (r *mutationResolver) RecordSpo2(ctx context.Context, input dto.ObservationInput) (*dto.Observation, error) {
	r.CheckDependencies()
	return r.usecases.RecordSpo2(ctx, input)
}
