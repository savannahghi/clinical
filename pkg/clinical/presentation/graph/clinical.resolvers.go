...
func (r *queryResolver) GetPatientConditions(ctx context.Context, patientID string) ([]*dto.Condition, error) {
	panic(fmt.Errorf("not implemented: GetPatientConditions - getPatientConditions"))
}
