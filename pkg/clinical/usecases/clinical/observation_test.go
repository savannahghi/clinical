...
func TestUseCasesClinicalImpl_PatchPatientObservations(t *testing.T) {
	...
	for _, tt := range tests {
		...
		_, err := u.PatchPatientObservations(tt.args.ctx, tt.args.id, tt.args.input)
		if (err != nil) != tt.wantErr {
...
func TestUseCasesClinicalImpl_PatchPatientHeightEntries(t *testing.T) {
	type args struct {
		ctx   context.Context
		id    string
		input dto.PatchObservationInput
	...
	for _, tt := range tests {
		...
		_, err := u.PatchPatientHeightEntries(tt.args.ctx, tt.args.id, tt.args.input)
		if (err != nil) != tt.wantErr {
			t.Errorf("PatchPatientHeightEntries() error = %v, wantErr %v", err, tt.wantErr)
			return
		}
	}
}

func TestUseCasesClinicalImpl_PatchPatientWeightEntries(t *testing.T) {
	type args struct {
		ctx   context.Context
		id    string
		input dto.PatchObservationInput
	...
	for _, tt := range tests {
		...
		_, err := u.PatchPatientWeightEntries(tt.args.ctx, tt.args.id, tt.args.input)
		if (err != nil) != tt.wantErr {
			t.Errorf("PatchPatientWeightEntries() error = %v, wantErr %v", err, tt.wantErr)
			return
		}
	}
}
