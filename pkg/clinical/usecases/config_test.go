...
import (
	...
	fhirRepoMock "github.com/savannahghi/clinical/pkg/clinical/infrastructure/datastore/fhirdataset/mock"
	fb "github.com/savannahghi/clinical/pkg/clinical/infrastructure/datastore/firebase"
	fbMock "github.com/savannahghi/clinical/pkg/clinical/infrastructure/datastore/firebase/mock"
...
var (
	...
	fakeFirebaseRepo fbMock.FakeFirebase
...
func InitializeFakeTestlInteractor(ctx context.Context) (usecases.Interactor, error) {
	...
	var fhirRepo dataset.FHIRRepository = &FHIRRepoMock
	var repo fb.FirestoreRepository = &fakeFirebaseRepo
