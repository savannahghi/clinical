...
// PatientWelcomeEmail is welcome email template for successfully patient registration
...
<head>
    ...
    <meta property="description" content="Successful registration">
    <!--VIEWPORT-->
...
<body width="100%" style="margin: 0; padding: 0 !important; background-color: #f1f1f1;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em;">
                                        ...
                                        <p style="margin: 0;">
                                            Your registration has been successful. Welcome to AfyaMoja and thank you for
                                            choosing us.</p>
    ...
    <script>
        ...
        analytics.logEvent('opened_patient_welcome_email');
    </script>
</body>
...
// AdminEmailMessage is breakglass notification email sent to admins
...
<head>
    <title>Be.Well Professional by Slade 360° - Connected healthcare platform. </title>
    <meta property="description" content="Break glass emergency override notice">
    <!--VIEWPORT-->
    <meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=no;">
    <meta name="viewport" content="width=600, initial-scale = 2.3, user-scalable=no">
    <meta name="viewport" content="width=device-width">
...
<body width="100%" style="margin: 0; padding: 0 !important; background-color: #f1f1f1;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em;">
                                        ...
                                        <p>
                                            This is a breaking glass access notice.
                                        </p>
                                        <p style="margin: 0;">
                                            The health record for {{.Name}} has been accessed by a break glass emergency
                                            override.
                                        </p>
                                        <p> Patient: {{.Name}} </p>
                                        <p> Patient Contact: {{.Number}}</p>
    ...
    <script>
        ...
        analytics.logEvent('opened_break_glass_notice_email');
    </script>
</body>
